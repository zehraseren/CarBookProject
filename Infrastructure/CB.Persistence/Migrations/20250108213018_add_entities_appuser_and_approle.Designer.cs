...
namespace CB.Persistence.Migrations
{
    ...
    [Migration("20250108213018_add_entities_appuser_and_approle")]
    partial class add_entities_appuser_and_approle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CB.Domain.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.Author", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.Blog", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.RentACar", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.RentACarProcess", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.Property<int>("DrivingLicenseAge")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CB.Domain.Entities.Review", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.TagCloud", b =>
                {
            ...
            modelBuilder.Entity("CB.Domain.Entities.AppUser", b =>
                {
                    b.HasOne("CB.Domain.Entities.AppRole", "AppRole")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("CB.Domain.Entities.Blog", b =>
                {
                    b.HasOne("CB.Domain.Entities.Author", "Author")
                        .WithMany("Blogs")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CB.Domain.Entities.Category", "Category")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("CB.Domain.Entities.Comment", b =>
                {
                    b.HasOne("CB.Domain.Entities.Blog", "Blog")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("CB.Domain.Entities.RentACar", b =>
                {
                    ...
                    b.HasOne("CB.Domain.Entities.Location", "Location")
                        .WithMany("RentACars")
            ...
            modelBuilder.Entity("CB.Domain.Entities.RentACarProcess", b =>
                {
                    ...
                    b.HasOne("CB.Domain.Entities.Customer", "Customer")
                        .WithMany("RentACarProcesses")
            ...
            modelBuilder.Entity("CB.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("CB.Domain.Entities.Location", "DropOffLocation")
                        .WithMany("DropOffReservations")
                        .HasForeignKey("DropOffLocationId");

                    b.HasOne("CB.Domain.Entities.Location", "PickUpLocation")
